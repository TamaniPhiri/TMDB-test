...
const styles = {
  container:
    " min-h-screen flex flex-col gap-4 items-center justify-center text-center px-4 md:px-12",
  btn: " bg-[#BFCDE0] text-gray-800 hover:scale-105 duration-150 active:scale-95 p-4 rounded-full",
};
